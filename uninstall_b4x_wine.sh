...
readonly B4A_DESKTOP_ENTRY="${HOME}/.local/share/applications/b4a-wine.desktop"
readonly B4J_DESKTOP_ENTRY="${HOME}/.local/share/applications/b4j-wine.desktop"
readonly B4A_DESKTOP_SHORTCUT="${HOME}/Desktop/b4a-wine.desktop"
readonly B4J_DESKTOP_SHORTCUT="${HOME}/Desktop/b4j-wine.desktop"
