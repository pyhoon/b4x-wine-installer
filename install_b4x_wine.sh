...
echo "  • Uninstaller: ./uninstall_b4a_wine.sh ← Run to remove B4A only"
echo "  • Uninstaller: ./uninstall_b4j_wine.sh ← Run to remove B4J only"
...
echo "  • Reset everything? Run ./uninstall_b4a_wine.sh --force && ./uninstall_b4j_wine.sh --force && ./install_b4x_wine.sh"
echo ""
